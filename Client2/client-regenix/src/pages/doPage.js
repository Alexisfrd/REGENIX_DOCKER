    ...
    <div className="flex h-[100vh] bg-gray-100">
      ...
      <div className="flex-1 p-4 grid grid-cols-4 gap-2 justify-items-auto">
        ...
        <div className="space-y-4 col-span-4">
          <CsvChart parameter="do" key={refreshKey}/>
          {/* Bouton pour vider le cache */}
        </div>
        <div className="flex space-x-4 col-span-4">
          <div className="w-1/3">
            <BarChart parameter="do" key={refreshKey}/>
          </div>
          <div className="w-1/3">
            <Statistic parameter="do" key={refreshKey}/>
          </div>
          <div className="w-1/3">
            <Filtre parameter="do" onRefresh={handleRefresh}/>
          </div>
        </div>
      </div>
    </div>
